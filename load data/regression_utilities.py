...
# This is originally used in Aleksander Grochowicz, Koen van Greevenbroek, Fred Espen Benth, Marianne Zeyringer,
# Intersecting near-optimal spaces: European power systems with more resilience to weather variability,
# Energy Economics, doi.org/jxtw and published in https://github.com/aleks-g/multidecade-data/releases/tag/v1.0.
